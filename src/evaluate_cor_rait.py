...
def main():
    ...
    model_pth = f"../output_models/{model_name}-cor-rait/merge"
    ...
    with open(f"../data/Qwen2-7B/split_data/id_test.json", 'r') as f:
        data = json.load(f)
    ...
    # 保存评估结果
    save_dir = f"../result/2.2.2/Qwen2-7B/cor-rait-0.25-0.75/test"
