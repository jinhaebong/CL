...
def main():
    ...
    with open(f"../data/{model_name}/split_data/indomain_train.json", 'r') as f:
        data = json.load(f)
    ...
    # 保存评估结果
    save_dir = f"../data/Qwen2-7B/traindata/rait_1_finetune_results"
    save_file = f"indomain_train.json" 
