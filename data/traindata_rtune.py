...
output_file = "traindata/rtune/rtune_indomain_train.json"  
...
for subject, questions in inferred_data.items():
    for question in questions:
        ...
        if question["kb"] == "Known":
            text = f"{full_input}Are you sure you accurately answered the question based on your internal knowledge? I am sure."
        else:
            text = f"{full_input}Are you sure you accurately answered the question based on your internal knowledge? I am unsure."

        # 添加到实例中
        formatted_data["instances"].append({"text": text})
