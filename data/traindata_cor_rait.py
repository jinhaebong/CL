...
input_file = "Qwen2-7B/traindata/cor-rait/final_questions.json"  
prompt_file = "MMLU/dev.json"
output_file = "Qwen2-7B/traindata/cor-rait/train/rait_indomain_train.json"  
...
for subject, questions in inferred_data.items():
    ...
    for question in questions:
        ...
        if question["kb"]["Correctness"]["result"] == "Known":
