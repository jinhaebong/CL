...
input_file = "Qwen2-7B/traindata/rait_2/indomain_train.json"  
prompt_file = "MMLU/dev.json"
output_file = "Qwen2-7B/traindata/rait_2/rait_2_indomain_train.json"  
...
for subject, questions in inferred_data.items():
    ...
    for question in questions:
        ...
        if question["kb"]["Final_Correctness"]["result"] == "Known":
